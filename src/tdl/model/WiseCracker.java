...
public class WiseCracker {
    ...
    wiseStuff.add("Pausen: es gibt besseres als browsen! Höre Musik und schreibe dem wise man. Ideal: schreibe zusammen was gerade zu tun ist, ohne es gleich zu tun.");
